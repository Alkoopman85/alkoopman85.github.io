...
This is a collection of Notebooks designed for educational purposes, implementing machine learning models in pure python. These are not meant for production purposes but to provide a deeper understanding of the algorithms that are behind the the models we use everyday. This is a continuing project and as I progress with this, more sophisticated implementations will be included as well as more model types and families.
